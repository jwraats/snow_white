...
--
-- Host: localhost:8889
-- Generation Time: Oct 25, 2014 at 01:24 PM
...
INSERT INTO `feed` (`id`, `user_id`, `session`, `created`, `title`, `message`) VALUES
(1, 1, 1414225029431, 15025545, 'Cool', 'Nice... WHat? NICE!'),
(7, 1, 1414225050996, 1414236080, 'Nice', 'NIce');
...
(1, '/assets/profile.jpg', 'Papa', 'Label A', 'jw', '17f931f4c13d4983a77fe59dfe349e3e'),
(2, '/images/baard.jpg', 'Mama', 'Label A', 'man', '39c63ddb96a31b9610cd976b896ad4f0'),
